    ...
    <div className="p-6 md:p-8 max-w-[900px]" dir="rtl">
      ...
      <div className="space-y-5">
        ...
        <div className="bg-[#0D0D0D] border border-[#1A1A1A] rounded-2xl p-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {[
              ...
              { label: "Slug (تلقائي)", value: slug, set: setSlug, placeholder: "oversized-linen-blazer" },
        ...
        <div className="bg-[#0D0D0D] border border-[#1A1A1A] rounded-2xl p-5">
          ...
          {/* URL input */}
          // ✅ بعد — رفع من الجهاز + الرابط كـ خيار ثانوي
<input
  ref={fileInputRef}
  type="file"
  accept="image/*"
  ...
  >
    ...
    إضافة
        ...
        <motion.button
          ...
          onClick={handleSave}
          disabled={saving}
          className="w-full flex items-center justify-center gap-2 bg-[#C9A86E] text-[#060606] rounded-2xl py-4 text-[14px] font-bold font-tajawal hover:brightness-110 transition-all disabled:opacity-60 shadow-[0_8px_24px_#9A784840]"
        >
          {saving ? (
