      ...
      <div className="space-y-5">
        ...
        <div className="bg-[#F5F3EF] border border-[#EAE7E1] rounded-xl p-4">
          <p className="text-[11px] text-[#6B6560] font-tajawal">
            ⚠️ بعد الإضافة، سيظهر المنتج في قائمة منتجاتك بحالة 
            <span className="text-[#A8823C] font-bold"> "انتظار" </span>
            لحين مراجعة الإدمن واعتماده. لن يكون مرئياً للعملاء حتى الموافقة.
          </p>
        </div>
      </div>
    </div>
